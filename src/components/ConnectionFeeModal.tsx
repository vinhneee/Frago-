        ...
        <div className="space-y-6 py-4">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
            ...
            <p className="text-xs text-green-600 mt-1">
              You matched with <span className="font-semibold">{matchedCompany}</span>
            </p>
          </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
            <p className="text-xs text-gray-600 leading-relaxed">
              <span className="font-semibold">Note:</span> The connection fee is calculated as 5% of your contract value. This fee enables our platform to facilitate successful business partnerships.
            </p>
          </div>
        </div>
